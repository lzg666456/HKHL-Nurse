...
- (instancetype)initWithDataSource:(NSArray *)data ChildType:(ChildDataType)type Key:(NSString *)key{
    ...
    if (self) {
        ...
        _tableView.y = (KSCREEN_HEIGHT-_tableView.frame.size.height-64)/2.0;
...
- (void)setData:(NSArray *)data ChildType:(ChildDataType)type getKey:(NSString *)key{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.font = [UIFont systemFontOfSize:FONT_SIZE_MIDDLE];
